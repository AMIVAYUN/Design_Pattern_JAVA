...
public class CalcV1 {
    ...
    SecondOperateState secondOperateState= new SecondOperateState(this);
    OperatorState operatorState= new OperatorState(this);
    FirstOperandState firstOperandState=new FirstOperandState(this);
    ...
    void processNumber(String ch) {
        this.state.processNumber(ch);

    }

    /* 사칙 연산자 혹은 = 연산자 처리 */
    void processOperator(char ch) {
        this.state.processOperator(ch);
    }
